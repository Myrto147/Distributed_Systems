...
public class Broker extends Node {
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException {
        Broker broker=new Broker("192.168.1.9",5002
    ...
    public void openServer(){
        ...
        try {
            ...
            //thread that handles com.aueb.spotifypro.Consumer
            while(true) {
                connectCon = ConsumerServer.accept();
                //sos
                //System.out.println("com.aueb.spotifypro.Consumer connected! --> " + connectCon.getInetAddress().getHostAddress());
