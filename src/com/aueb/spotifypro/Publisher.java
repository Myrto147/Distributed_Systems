...
public class Publisher extends Node {
    ...
    public static void main(String args[]) throws NoSuchAlgorithmException, InvalidDataException, IOException, UnsupportedTagException {
        Publisher pub=new Publisher('a', 'z', "192.168.1.9", 4090, "192.168.1.9", 2012);//kathe fora allazoyme to pub port
    ...
    public void exchangeInfo() throws IOException {
        ...
        for (int i = 0; i < N; i++) {
            try {
                //System.out.println("CONNECTED---> " + availableBrokers[i][1]);
            ...
            Thread requestListener = new Thread() {
                public void run() {
                    ...
                    try {
                        ...
                        System.out.println("com.aueb.spotifypro.Consumer's Artist request: " + requestArtist);
                        System.out.println("com.aueb.spotifypro.Consumer's Song request: " + requestSong);
